...
- Commands: look (l), move <n/s/e/w> (m <dir>), attack [name], end turn, wait, food, rest, sleep, use bandage, use antidote, get <item>, get from corpse, descend, inventory, stats. NEW (v1.8): reckless, guard, second wind, sneak, backstab, disarm, pick, intimidate <target>.
