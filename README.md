...
**Requires Zig 0.15+** (tested on 0.15.2). **Version:** `1.9.0` — Survival-clock easing + descend-milestone HP growth (see `docs/CLOCK_PROGRESSION.md`).
...
| Version | Theme |
|---------|--------|
| **1.9.0** | Survival-clock easing + descend-milestone HP growth: deep-floor move tax gates at ex≥2; deep-floor tick stack clamped to +1; penalty tiers 62/78/90/97 (0/1 frozen); CON-scaled +2/3/4 HP per descend (cap +16). First deliberate `reference_crawl` re-bless (HP lines + growth notices only; clock lines byte-identical). See `docs/CLOCK_PROGRESSION.md`. |
